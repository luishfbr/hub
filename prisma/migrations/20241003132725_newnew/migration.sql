/*
  ...
  - You are about to drop the column `id` on the `MeetingUser` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "MeetingUser" DROP CONSTRAINT "MeetingUser_pkey",
DROP COLUMN "id",
ADD CONSTRAINT "MeetingUser_pkey" PRIMARY KEY ("meetingId");
